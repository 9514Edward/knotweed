...
## Next Steps
 ...
 - Just learned that there is a thing called an oak-1 camera that can run the model, which will free up the raspberry pi for other functionality.  So, I'm going to get this going at some point.
